import{_ as n,o as s,c as a,a as e}from"./app-0c263564.js";const i={},l=e(`<h1 id="忘了" tabindex="-1"><a class="header-anchor" href="#忘了" aria-hidden="true">#</a> 忘了</h1><p><strong>查看端口</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">lsof</span> <span class="token parameter variable">-i</span> <span class="token punctuation">[</span>port<span class="token punctuation">]</span>
