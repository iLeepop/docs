import{_ as s,o as n,c as a,a as e}from"./app-6b584a3c.js";const t={},i=e(`<h1 id="ssl" tabindex="-1"><a class="header-anchor" href="#ssl" aria-hidden="true">#</a> SSL</h1><p>去下载你的ssl证书文件。</p><p>上传到服务器，解压。</p><p>得到 <strong>.crt</strong> 以及 <strong>.key</strong> 文件。</p><p>打开 <strong>nginx.conf</strong> 文件：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /etc/nginx/
