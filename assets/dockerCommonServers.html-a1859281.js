import{_ as i,r as l,o as r,c as d,b as a,d as e,e as t,a as s}from"./app-6b584a3c.js";const c={},p=s('<h1 id="常用服务器安装" tabindex="-1"><a class="header-anchor" href="#常用服务器安装" aria-hidden="true">#</a> 常用服务器安装</h1><h2 id="mysql-普通安装" tabindex="-1"><a class="header-anchor" href="#mysql-普通安装" aria-hidden="true">#</a> MySQL 普通安装</h2><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>可能有些 sql 的结尾没有写[;]，各位注意一下。</p></div>',3),o={href:"https://hub.docker.com",target:"_blank",rel:"noopener noreferrer"},v=s(`<h3 id="拉取镜像" tabindex="-1"><a class="header-anchor" href="#拉取镜像" aria-hidden="true">#</a> 拉取镜像</h3><p>先拉取 MySQL5.7 的镜像到本地。（任意版本皆行）</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull mysql:5.7
